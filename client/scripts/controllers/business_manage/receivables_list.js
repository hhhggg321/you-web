...
angular.module('concordyaApp')
  .controller('ReceivablesListCtrl', ['$scope', '$state', 'APIService', 'UtilityService', 'WidgetService', 'ModalBoxService', 'CONSTANT.PAGE_SIZE',
    function($scope, $state, api, utility, widget, modalBox, PAGE_SIZE) {
      ...
      function getDataList(params) {
        ...
        api.receivables.getList(params)
          .success(function(data, status) {
            if (status === 200) {
              $scope.dataList = data.receivables;
      ...
      // trigger receivables selected status
