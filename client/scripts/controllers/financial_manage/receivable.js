...
angular.module('concordyaApp')
        .controller('ReceivableCtrl', ['$scope', '$translate', '$translatePartialLoader', 'APIService', 'WidgetService', 'UtilityService', 'CONSTANT.PAGE_SIZE',
          function ($scope, $translate, $translatePartialLoader, api, widget, utility, PAGE_SIZE) {
            ...
            $scope.save = function () {
              ...
              if (diff && diff.length > 0) {
                ...
                api.receivable.update(data)
                        .success(function () {
                          widget.showSuccess($translate.instant('RECEIVABLE.MESSAGE_UPDATE_SUCCESS'));
                          getDataList();
                        });
              }
            };
